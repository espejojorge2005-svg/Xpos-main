      ...
      <header className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6 sm:mb-8 bg-white p-4 sm:p-6 rounded-3xl shadow-sm border border-slate-100">
        <div>
          <h1 className="text-2xl sm:text-3xl font-black text-slate-900 tracking-tight flex items-center gap-2 sm:gap-3">
            <ChefHat className="text-orange-500 w-7 h-7 sm:w-8 sm:h-8" /> 
        ...
        <button 
          onClick={() => openModal()}
          className="w-full sm:w-auto justify-center flex items-center gap-2 px-5 sm:px-6 py-2.5 sm:py-3 bg-orange-500 hover:bg-orange-600 text-white rounded-2xl font-bold text-xs sm:text-sm transition-all active:scale-95 shadow-lg shadow-orange-200"
        >
